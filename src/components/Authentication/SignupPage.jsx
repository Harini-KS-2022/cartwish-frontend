      ...
      >
        ...
        <div className="form_inputs signup_form_input">
          <div>
            ...
            />
            {errors.name && (
              <em className="forms_error">{errors.name.message}</em>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.email && (
              <em className="forms_error">{errors.email.message}</em>
            )}
          </div>
          ...
          <div>
            ...
            {errors.confirmPassword && (
              <em className="forms_error">{errors.confirmPassword.message}</em>
            )}
          </div>
          ...
          <div className="signup_textares_section">
            ...
            {errors.deliveryAddress && (
              <em className="forms_error">{errors.deliveryAddress.message}</em>
            )}
          </div>
        </div>
