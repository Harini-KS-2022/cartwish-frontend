  ...
  return (
    <nav className="navbar align_center">
      <div className="align_center">
        {/* <h2 className="navbar_heading">Shree Sapthagiri Life Care</h2> */}
        <h2 className="navbar_heading">CartWish</h2>
        <form
          action=""
        ...
        {user && (
          <>
            ...
            <NavLink to="/cart" className="align_center">
              Cart <p className="cart_counts align_center">{cart.length}</p>
            </NavLink>
          </>
        )}
      </div>
